public class Main {
    public static void main(String[] args) {
        ...
        Complex[][] abc = { { new Complex(1), new Complex(2), new Complex(3) }, 
                          { new Complex(4), new Complex(5),new Complex(6) }, 
                          { new Complex(10), new Complex(8), new Complex(9)} };
        Matrix ABC = new Matrix(abc);
        System.out.println(ABC.determinant());
    }
}
